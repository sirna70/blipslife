...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Tambah Data Asuransi</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('insured-data.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="birth_of_date" name="birth_of_date" value="{{ old('birth_of_date') }}">
                        </div>
